...
class AdministradorRoute {
    ...
    public init() {
        this.router.get('/sair', this.logout);
        this.router.get('/session/:id', this.session);
        this.router.get('/clientes', this.clientes);
        this.router.get('/painel', this.painel);
        this.router.get('/charts', this.charts);
    }
}

const administradorRouter = new AdministradorRoute();
administradorRouter.init();
 

export default administradorRouter.router;